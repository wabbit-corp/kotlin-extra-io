...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-extra-io", "1.0.1")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-extra-io")
        description.set("kotlin-extra-io")
        url.set("https://github.com/wabbit-corp/kotlin-extra-io")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-extra-io")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-extra-io.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-extra-io.git")
        }
    }
}
...
kover {
    ...
    //             // title.set("kotlin-extra-io Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    moduleName.set("kotlin-extra-io")
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-extra-io/tree/master/src/main/kotlin")
