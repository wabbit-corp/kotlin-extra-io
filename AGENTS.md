...
- Canonical repo target: `kotlin-extra-io`. Useful entrypoints: `dev project show kotlin-extra-io`, `dev build kotlin-extra-io`, `dev check kotlin-extra-io`.
- Setup-managed files are regenerated with `dev setup kotlin-extra-io`; avoid hand-editing stamped generated files.
